...
import { Stethoscope, Bot, User, Thermometer, Heart, Brain, Atom as Stomach, Bone, Eye, Ear, Settings as Lungs, AlertCircle, CheckCircle, Clock, Zap, ShoppingCart as CartIcon } from 'lucide-react';
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-green-100 to-emerald-100 rounded-xl p-4 border-2 border-green-300">
                ...
                <ul className="space-y-2">
                  {(diagnosis.naturalRemedies as string[]).map((remedy: string, index: number) => (
              ...
              <div className="bg-gradient-to-r from-orange-100 to-yellow-100 rounded-xl p-4 border-2 border-orange-300">
                ...
                <ul className="space-y-2">
                  {(diagnosis.foods as string[]).map((food: string, index: number) => (
                    <li key={index} className="text-sm text-gray-700 flex items-start">
              ...
              <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-xl p-4 border-2 border-purple-300">
                ...
                <ul className="space-y-2">
                  {(diagnosis.medications as string[]).map((med: string, index: number) => (
                    <li key={index} className="text-sm text-gray-700 flex items-start">
              ...
              <div className="bg-gradient-to-r from-blue-100 to-cyan-100 rounded-xl p-4 border-2 border-blue-300">
                ...
                <ul className="space-y-2">
                  {(diagnosis.administration as string[]).map((instruction: string, index: number) => (
                    <li key={index} className="text-sm text-gray-700 flex items-start">
